...
parser.add_argument('--excel_path', type=str, default='risultatiDeepFaceHRFAE.xlsx', help='Percorso del file Excel di output')
...
for filename in os.listdir(args.folder_path):
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        actual_age = int(parts[-1].split('_')[-1].split('.')[0])
