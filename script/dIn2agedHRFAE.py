...
def main(dataset_dir, output_dir, result_file):
    ...
    age_ranges = [(18, 19), (20, 29), (30, 39), (40, 49), (50, 59), (60, 69), (70, 79), (80, 89), (90, 99)]
    ...
    for file_name in os.listdir(dataset_dir):
        if file_name.endswith('.npy'):
            ...
            image_png_path = os.path.join(dataset_dir, f"{base_name}.jpg")
...
if __name__ == "__main__":
    ...
    result_file = "distancesIn2agedHRFAE_adaface.xlsx"
